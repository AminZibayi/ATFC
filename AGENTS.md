...
1. **Developing Python Pipelines**:
   Add a target to `apps/bibliometric-pipeline/project.json` or `apps/canonicalization-workflow/project.json`. Map it to a module execution `uv run python -m app_name.my_module`.
