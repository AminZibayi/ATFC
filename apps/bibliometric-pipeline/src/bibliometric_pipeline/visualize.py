...
inst_G = nx.read_graphml(CONFIG["input_dir"] / "02_institutional_graph.graphml")
fund_G = nx.read_graphml(CONFIG["input_dir"] / "02_funding_graph.graphml")
journal_G = nx.read_graphml(CONFIG["input_dir"] / "02_journal_graph.graphml")

inst_nodes_df = pd.read_excel(CONFIG["input_dir"] / "institutional_nodes.xlsx")
inst_edges_df = pd.read_excel(CONFIG["input_dir"] / "institutional_edges.xlsx")
fund_nodes_df = pd.read_excel(CONFIG["input_dir"] / "funding_nodes.xlsx")
fund_edges_df = pd.read_excel(CONFIG["input_dir"] / "funding_edges.xlsx")
journal_nodes_df = pd.read_excel(CONFIG["input_dir"] / "journal_nodes.xlsx")
journal_edges_df = pd.read_excel(CONFIG["input_dir"] / "journal_edges.xlsx")
